    ...
    class Program___Alen
    {
        ...
        static void insertRequest()
        {
            using (SchoolContext context = new SchoolContext())
            {
                ...
                string requestType1 = Console.ReadLine();
                while (requestType1 == "")
                {
                    Console.Write("Please input the type of the request [1.ITRequest, 2.OfficeRequest] : ");
                    requestType1 = Console.ReadLine();
                }
                string requestMessage1 = Console.ReadLine();
                while (requestMessage1 == "")
                {
                    Console.Write("Please enter the request message : ");
                    requestMessage1 = Console.ReadLine();
                }

                Request request = new Request()
                {
                    requestType = (RequestType)Convert.ToInt32(requestType1),
