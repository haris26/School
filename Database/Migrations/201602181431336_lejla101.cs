namespace Database.Migrations
{
    ...
    public partial class lejla101 : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Name = c.String(),
                        Status = c.Int(nullable: false),
                        ResourceCategory_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ResourceCategories", t => t.ResourceCategory_Id)
                .Index(t => t.ResourceCategory_Id);
                ...
                c => new
                    {
                        ...
                        PtoTime = c.Double(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Characteristics", "Resource_Id", "dbo.Resources");
            DropForeignKey("dbo.Resources", "ResourceCategory_Id", "dbo.ResourceCategories");
            DropForeignKey("dbo.CharacteristicNames", "ResourceCategory_Id", "dbo.ResourceCategories");
            DropForeignKey("dbo.AssetChars", "Asset_Id", "dbo.Assets");
            ...
            DropIndex("dbo.CharacteristicNames", new[] { "ResourceCategory_Id" });
            DropIndex("dbo.Resources", new[] { "ResourceCategory_Id" });
            DropIndex("dbo.Characteristics", new[] { "Resource_Id" });
            ...
            DropIndex("dbo.AssetChars", new[] { "Asset_Id" });
            ...
            DropTable("dbo.Days");
            DropTable("dbo.CharacteristicNames");
